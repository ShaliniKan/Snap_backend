...
export const AuthProvider = ({ children }) => {
    ...
    const openLogin = useCallback((intent) => {
        if (intent) {
    ...
    const openRegister = useCallback((intent = "customer") => {
        setAuthIntent(intent);
        setAuthModal(intent === "vendor" ? "register-vendor" : "register");
    }, []);

    const openRegisterVendor = useCallback(() => {
        setAuthIntent("vendor");
        setAuthModal("register-vendor");
    }, []);
